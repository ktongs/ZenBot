function hdb = importHand(filename, startRow, endRow)
%IMPORTFILE2 Import numeric data from a text file as a matrix.
%   HDB = IMPORTFILE2(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   HDB = IMPORTFILE2(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   hdb = importfile2('hdb', 1, 581);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/12/21 19:16:22
...
hdb = table(dataArray{1:end-1}, 'VariableNames', {'Var1','Var2','Var3','Var4','Var5','Var6','Var7','Var8','Var9','Var10','Var11','Var12','Var13'});
